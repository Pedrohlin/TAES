...
$.ajax({
    type: "GET",
    url: "https://github.com/Pedrohlin/portifolio/tree/main/OTES12%20-%20calc",
    cache: false,
    data: dataString,
    sucess: function(html) {
        alert("Sucess");
        $.getJSON('https://github.com/Pedrohlin/portifolio/tree/main/OTES12%20-%20calc', dataString, function(html){
